...
r_fasttree_fix90 = {'r':np.array([-4]*20+[-3]*20+[-2]*20+[-1]*20+[0]*20), # values of r (log-scaled)
                    'cherries':np.array([0.052,0.048,0.059,0.057,0.053,0.055,0.045,0.049,0.054,0.071,0.044,0.048,0.065,0.051,0.045,0.047,0.057,0.061,0.046,0.064] + # r = 0.0001
...
r_fasttree_fix95 = {'r':np.array([-4]*20+[-3]*20+[-2]*20+[-1]*20+[0]*20), # values of r (log-scaled)
                    'cherries':np.array([0.026,0.026,0.026,0.031,0.024,0.026,0.021,0.027,0.025,0.033,0.03,0.025,0.036,0.021,0.026,0.028,0.025,0.026,0.026,0.032] +  # r = 0.0001
...
r_raxml_fix95 = {'r':np.array([-4]*20+[-3]*20+[-2]*20+[-1]*20+[0]*20), # values of r (log-scaled)
                 'cherries':np.array([0.006,0.006,0.004,0.008,0.006,0.008,0.005,0.006,0.005,0.01,0.006,0.003,0.006,0.006,0.003,0.007,0.007,0.004,0.005,0.007] +  # r = 0.0001
...
r2_fasttree_fix90 = {'r':np.array([-4]*20+[-3]*20+[-2]*20+[-1]*20+[0]*20), # values of r (log-scaled)
                     'cherries':np.array([0.017,0.013,0.023,0.023,0.028,0.024,0.03,0.025,0.02,0.022,0.027,0.023,0.023,0.023,0.021,0.023,0.016,0.025,0.023,0.021] +  # r = 0.0001
...
r2_fasttree_fix95 = {'r':np.array([-4]*20+[-3]*20+[-2]*20+[-1]*20+[0]*20), # values of r (log-scaled)
                     'cherries':np.array([0.011,0.008,0.013,0.011,0.013,0.014,0.015,0.012,0.011,0.01,0.015,0.014,0.014,0.013,0.01,0.011,0.01,0.017,0.014,0.011] +   # r = 0.0001
...
r2_raxml_fix95 = {'r':np.array([-4]*20+[-3]*20+[-2]*20+[-1]*20+[0]*20), # values of r (log-scaled)
                  'cherries':np.array([0.011,0.007,0.008,0.009,0.012,0.011,0.009,0.01,0.01,0.008,0.007,0.011,0.011,0.012,0.009,0.012,0.009,0.013,0.01,0.009] +    # r = 0.0001
...
l_fasttree_fix90 = {'lambda':np.array([33.866]*20+[84.664]*20+[169.328]*20+[338.655]*20+[846.638]*20),
                    'cherries':np.array([0.089,0.09,0.093,0.097,0.087,0.092,0.096,0.104,0.095,0.08,0.099,0.083,0.088,0.096,0.099,0.094,0.086,0.096,0.099,0.092] +   # lambda = 33.86550309051126
...
l_fasttree_fix95 = {'lambda':np.array([33.866]*20+[84.664]*20+[169.328]*20+[338.655]*20+[846.638]*20),
                    'cherries':np.array([0.085,0.085,0.089,0.093,0.086,0.087,0.096,0.101,0.093,0.08,0.096,0.08,0.085,0.092,0.094,0.093,0.083,0.093,0.095,0.088] +   # lambda = 33.86550309051126
...
l_raxml_fix95 = {'lambda':np.array([33.866]*20+[84.664]*20+[169.328]*20+[338.655]*20+[846.638]*20),
                 'cherries':np.array([0.083,0.083,0.088,0.09,0.085,0.085,0.095,0.102,0.091,0.079,0.095,0.08,0.084,0.092,0.094,0.092,0.082,0.091,0.094,0.087] +   # lambda = 33.86550309051126
...
k_fasttree_fix90 = {'length':np.array([50]*20+[100]*20+[200]*20+[300]*20+[600]*20+[1200]*20+[2400]*20+[4800]*20), # values of length
                    'cherries':np.array([0.144,0.126,0.129,0.122,0.127,0.123,0.13,0.118,0.127,0.124,0.135,0.127,0.115,0.11,0.131,0.115,0.102,0.125,0.126,0.13] +    # length = 50
...
k_fasttree_fix95 = {'length':np.array([50]*20+[100]*20+[200]*20+[300]*20+[600]*20+[1200]*20+[2400]*20+[4800]*20), # values of length
                    'cherries':np.array([0.102,0.095,0.111,0.099,0.1,0.101,0.108,0.103,0.091,0.096,0.097,0.098,0.099,0.1,0.096,0.094,0.091,0.101,0.098,0.106] +     # length = 50
...
k_raxml_fix95 = {'length':np.array([50]*20+[100]*20+[200]*20+[300]*20+[600]*20+[1200]*20+[2400]*20+[4800]*20), # values of length
                 'cherries':np.array([0.012,0.018,0.019,0.016,0.018,0.022,0.022,0.016,0.015,0.018,0.022,0.02,0.018,0.022,0.022,0.018,0.013,0.021,0.015,0.019] +  # length = 50
...
g_fasttree_fix90 = {'gammarate':np.array([2.952]*20+[5.904]*20+[29.518]*20+[147.591]*20+[295.182]*20+[float('inf')]*20),
                    'cherries':np.array([0.097,0.09,0.096,0.093,0.09,0.083,0.085,0.106,0.093,0.086,0.095,0.089,0.104,0.098,0.085,0.094,0.101,0.085,0.095,0.091] +   # gamma = 2.95181735298926
...
g_fasttree_fix95 = {'gammarate':np.array([2.952]*20+[5.904]*20+[29.518]*20+[147.591]*20+[295.182]*20+[float('inf')]*20),
                    'cherries':np.array([0.077,0.078,0.084,0.075,0.08,0.075,0.08,0.083,0.08,0.076,0.086,0.076,0.093,0.08,0.078,0.077,0.083,0.072,0.081,0.08] +      # gamma = 2.95181735298926
...
sns.plt.show()
fig.savefig('cherries-fraction_vs_r_const-exp-branch-length_with-corrections.png', bbox_extra_artists=(legend,), bbox_inches='tight')
plt.close()
...
sns.plt.show()
fig.savefig('cherries-fraction_vs_r_const-lambda_with-corrections.png', bbox_extra_artists=(legend,), bbox_inches='tight')
plt.close()
...
sns.plt.show()
fig.savefig('cherries-fraction_vs_lambda_with-corrections.png', bbox_extra_artists=(legend,), bbox_inches='tight')
plt.close()
...
sns.pointplot(np.asarray([sum(k_fasttree['length'][i:i+20])/20.0 for i in range(0,len(k_fasttree['cherries']),20)]),[sum(k_fasttree['cherries'][i:i+20])/20.0 for i in range(0,len(k_fasttree['cherries']),20)],color=pal['fasttree'],linestyles=['--'],linewidth=3)
...
sns.pointplot(np.asarray([sum(k_fasttree_fix90['length'][i:i+20])/20.0 for i in range(0,len(k_fasttree_fix90['cherries']),20)]),[sum(k_fasttree_fix90['cherries'][i:i+20])/20.0 for i in range(0,len(k_fasttree_fix90['cherries']),20)],color=pal['fasttree_fix90'],linestyles=[':'],linewidth=3)
sns.violinplot(x='length',y='cherries',data=pd.DataFrame(k_raxml),order=x,color=pal['raxml'],width=0.3)
sns.pointplot(np.asarray([sum(k_raxml['length'][i:i+20])/20.0 for i in range(0,len(k_raxml['cherries']),20)]),[sum(k_raxml['cherries'][i:i+20])/20.0 for i in range(0,len(k_raxml['cherries']),20)],color=pal['raxml'],linestyles=['--'],linewidth=3)
sns.violinplot(x='length',y='cherries',data=pd.DataFrame(k_raxml_fix80),order=x,color=pal['raxml_fix80'],scale='width',width=0.3)
sns.pointplot(np.asarray([sum(k_raxml_fix80['length'][i:i+20])/20.0 for i in range(0,len(k_raxml_fix80['cherries']),20)]),[sum(k_raxml_fix80['cherries'][i:i+20])/20.0 for i in range(0,len(k_raxml_fix80['cherries']),20)],color=pal['raxml_fix80'],linestyles=[':'],linewidth=3)
sns.violinplot(x='length',y='cherries',data=pd.DataFrame(k_raxml_fix90),order=x,color=pal['raxml_fix90'],scale='width',width=0.3)
sns.pointplot(np.asarray([sum(k_raxml_fix90['length'][i:i+20])/20.0 for i in range(0,len(k_raxml_fix90['cherries']),20)]),[sum(k_raxml_fix90['cherries'][i:i+20])/20.0 for i in range(0,len(k_raxml_fix90['cherries']),20)],color=pal['raxml_fix90'],linestyles=[':'],linewidth=3)
setAlpha(ax,0.5)
...
sns.plt.show()
fig.savefig('cherries-fraction_vs_length_with-corrections.png', bbox_extra_artists=(legend,), bbox_inches='tight')
plt.close()
...
sns.plt.show()
fig.savefig('cherries-fraction_vs_gammarate_with-corrections.png', bbox_extra_artists=(legend,), bbox_inches='tight')
plt.close()