...
ax = sns.violinplot(x='r',y='inferred_r',data=pd.DataFrame(r_raxml_bl),order=x,color=pal['raxml_bl'],scale='width',width=0.3)
...
sns.violinplot(x='r',y='inferred_r',data=pd.DataFrame(r_raxml_cherries),order=x,color=pal['raxml_cherries'],scale='width',width=0.3)
...
fig = plt.figure()
x = np.array([-4,-3,-2,-1,0])
ax = sns.violinplot(x='r',y='inferred_r',data=pd.DataFrame(r2_raxml_bl),order=x,color=pal['raxml_bl'],scale='width',width=0.3)
...
sns.violinplot(x='r',y='inferred_r',data=pd.DataFrame(r2_raxml_cherries),order=x,color=pal['raxml_cherries'],scale='width',width=0.3)
...
ax = sns.violinplot(x='lambda',y='inferred_r',data=pd.DataFrame(l_raxml_bl),order=x,color=pal['raxml_bl'],scale='width',width=0.3)
sns.pointplot(np.asarray([sum(l_raxml_bl['lambda'][i:i+20])/20.0 for i in range(0,len(l_raxml_bl['inferred_r']),20)]),[sum(l_raxml_bl['inferred_r'][i:i+20])/20.0 for i in range(0,len(l_raxml_bl['inferred_r']),20)],color=pal['raxml_bl'],linestyles=[':'],linewidth=3)
sns.violinplot(x='lambda',y='inferred_r',data=pd.DataFrame(l_raxml_cherries),order=x,color=pal['raxml_cherries'],scale='width',width=0.3)
sns.pointplot(np.asarray([sum(l_raxml_cherries['lambda'][i:i+20])/20.0 for i in range(0,len(l_raxml_cherries['inferred_r']),20)]),[sum(l_raxml_cherries['inferred_r'][i:i+20])/20.0 for i in range(0,len(l_raxml_cherries['inferred_r']),20)],color=pal['raxml_cherries'],linestyles=[':'],linewidth=3)
setAlpha(ax,0.5)
...
ax = sns.violinplot(x='length',y='inferred_r',data=pd.DataFrame(k_raxml_bl),order=x,color=pal['raxml_bl'],scale='width',width=0.3)
sns.pointplot(np.asarray([sum(k_raxml_bl['length'][i:i+20])/20 for i in range(0,len(k_raxml_bl['inferred_r']),20)]),[sum(k_raxml_bl['inferred_r'][i:i+20])/20.0 for i in range(0,len(k_raxml_bl['inferred_r']),20)],color=pal['raxml_bl'],linestyles=[':'],linewidth=3)
sns.violinplot(x='length',y='inferred_r',data=pd.DataFrame(k_raxml_cherries),order=x,color=pal['raxml_cherries'],scale='width',width=0.3)
sns.pointplot(np.asarray([sum(k_raxml_cherries['length'][i:i+20])/20 for i in range(0,len(k_raxml_cherries['inferred_r']),20)]),[sum(k_raxml_cherries['inferred_r'][i:i+20])/20.0 for i in range(0,len(k_raxml_cherries['inferred_r']),20)],color=pal['raxml_cherries'],linestyles=[':'],linewidth=3)
setAlpha(ax,0.5)
plt.plot([-10,10],[-2,-2],label='Theoretical',linestyle='--',color=pal['theoretical'])
plt.yticks(axisY); plt.ylim(axisY[0],axisY[-1])
legend = plt.legend(handles=handles,bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0., frameon=True)
...
ax = sns.violinplot(x='gammarate',y='inferred_r',data=pd.DataFrame(g_raxml_bl),order=x,color=pal['raxml_bl'],scale='width',width=0.3)
sns.pointplot(np.asarray([sum(g_raxml_bl['gammarate'][i:i+20])/20.0 for i in range(0,len(g_raxml_bl['inferred_r']),20)]),[sum(g_raxml_bl['inferred_r'][i:i+20])/20.0 for i in range(0,len(g_raxml_bl['inferred_r']),20)],color=pal['raxml_bl'],linestyles=[':'],linewidth=3)
sns.violinplot(x='gammarate',y='inferred_r',data=pd.DataFrame(g_raxml_cherries),order=x,color=pal['raxml_cherries'],scale='width',width=0.3)
sns.pointplot(np.asarray([sum(g_raxml_cherries['gammarate'][i:i+20])/20.0 for i in range(0,len(g_raxml_cherries['inferred_r']),20)]),[sum(g_raxml_cherries['inferred_r'][i:i+20])/20.0 for i in range(0,len(g_raxml_cherries['inferred_r']),20)],color=pal['raxml_cherries'],linestyles=[':'],linewidth=3)
setAlpha(ax,0.5)
plt.plot([-10,10],[-2,-2],label='Theoretical',linestyle='--',color=pal['theoretical'])
plt.yticks(axisY); plt.ylim(axisY[0],axisY[-1])
legend = plt.legend(handles=handles,bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0., frameon=True)
...
ax = sns.violinplot(x='n',y='inferred_r',data=pd.DataFrame(n_raxml_bl),order=x,color=pal['raxml_bl'],scale='width',width=0.3)
sns.pointplot(np.asarray([sum(n_raxml_bl['n'][i:i+20])/20.0 for i in range(0,len(n_raxml_bl['inferred_r']),20)]),[sum(n_raxml_bl['inferred_r'][i:i+20])/20.0 for i in range(0,len(n_raxml_bl['inferred_r']),20)],color=pal['raxml_bl'],linestyles=[':'],linewidth=3)
sns.violinplot(x='n',y='inferred_r',data=pd.DataFrame(n_raxml_cherries),order=x,color=pal['raxml_cherries'],scale='width',width=0.3)
sns.pointplot(np.asarray([sum(n_raxml_cherries['n'][i:i+20])/20.0 for i in range(0,len(n_raxml_cherries['inferred_r']),20)]),[sum(n_raxml_cherries['inferred_r'][i:i+20])/20.0 for i in range(0,len(n_raxml_cherries['inferred_r']),20)],color=pal['raxml_cherries'],linestyles=[':'],linewidth=3)
setAlpha(ax,0.5)
plt.plot([-10,10],[-2,-2],label='Theoretical',linestyle='--',color=pal['theoretical'])
plt.yticks(axisY); plt.ylim(axisY[0],axisY[-1])
legend = plt.legend(handles=handles,bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0., frameon=True)
