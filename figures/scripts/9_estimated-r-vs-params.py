...
pal = {'simulated':'#597DBE', 'fasttree':'#FF9980', 'raxml':'#A2B7C3', 'theoretical':'#000000', 'fasttree_fix90':'#D41A1C', 'raxml_fix90':'#377EE8', 'raxml_fix80':'#4DAF4A', 'fasttree_bl':'#E6C594', 'fasttree_bl_bootlier_log':'#CE8F30', 'raxml_bl':'#62E1EA', 'raxml_bl_bootlier_log':'#37ACA4'}
#handles = [Patch(color=pal['theoretical'],label='Theoretical'),Patch(color=pal['fasttree'],label='FastTree'),Patch(color=pal['fasttree_fix90'],label='FastTree (Corrected, 90%)'),Patch(color=pal['fasttree_bl'],label='FastTree (Branch Lengths)'),Patch(color=pal['fasttree_bl_bootlier_log'],label='FastTree (Branch Lengths, Bootlier)'),Patch(color=pal['raxml'],label='RAxML'),Patch(color=pal['raxml_fix90'],label='RAxML (Corrected, 90%)'),Patch(color=pal['raxml_bl'],label='RAxML (Branch Lengths)'),Patch(color=pal['raxml_bl_bootlier_log'],label='RAxML (Branch Lengths, Bootlier)'),]
handles = [Patch(color=pal['theoretical'],label='Theoretical'),Patch(color=pal['fasttree'],label='FastTree'),Patch(color=pal['fasttree_bl'],label='FastTree (Branch Lengths)'),Patch(color=pal['fasttree_bl_bootlier_log'],label='FastTree (Branch Lengths, Bootlier)'),Patch(color=pal['raxml'],label='RAxML'),Patch(color=pal['raxml_bl'],label='RAxML (Branch Lengths)'),Patch(color=pal['raxml_bl_bootlier_log'],label='RAxML (Branch Lengths, Bootlier)'),]
...
sns.violinplot(x='r',y='cherries',data=pd.DataFrame(r_fasttree_bl),order=x,color=pal['fasttree_bl'],scale='width',width=0.3)
...
sns.violinplot(x='r',y='cherries',data=pd.DataFrame(r2_fasttree_bl),order=x,color=pal['fasttree_bl'],scale='width',width=0.3)
...
sns.violinplot(x='lambda',y='cherries',data=pd.DataFrame(l_fasttree_bl),order=x,color=pal['fasttree_bl'],scale='width',width=0.3)
...
sns.violinplot(x='length',y='cherries',data=pd.DataFrame(k_fasttree_bl),order=x,color=pal['fasttree_bl'],scale='width',width=0.3)
...
sns.violinplot(x='gammarate',y='cherries',data=pd.DataFrame(g_fasttree_bl),order=x,color=pal['fasttree_bl'],scale='width',width=0.3)
